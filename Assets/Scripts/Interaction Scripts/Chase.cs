...
public class Chase : MonoBehaviour
{
    ...
    void Update()
    {
		...
		if(Vector2.Distance(player.transform.position, detectCenter) < 5 && player.transform.position.y < 0){
			...
			if(Vector2.Distance(player.transform.position, detectCenter) < 1.2 && !isBattle){
